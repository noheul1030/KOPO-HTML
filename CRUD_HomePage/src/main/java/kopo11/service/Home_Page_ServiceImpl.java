...
public class Home_Page_ServiceImpl implements Home_Page_Service{
	
	private Home_PageDao home_PageDao;

	@Override
	public Home_PageDao getHome_PageDao() {
		return home_PageDao;
	}

	@Override
	public void setHome_PageDao(Home_PageDao home_PageDao) {
