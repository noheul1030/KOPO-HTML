...
<html>
	<head>
		...
		<style>
    		...
    		h1,h2,h4 {margin-top: 15px; text-align: left;}
    		.fourth {
			  background: gold;
			  border-color: white;
			  color: black;
...
%>
		...
		<table>
			<tr>
				<td bgcolor = #fff5ee colspan = "3" ><h2>[<%=key%>] 후보 조회</h2></td><!--해당 key값 head text 크기 2-->
			</tr>
			<tr>
				<td><h4>연령대별 조회 입니다.</h3></td>
				<td align = right width = 22%  style = "border-left: none;">
				<input class="fourth" type="submit" value="뒤로 가기" style="width: 70px; height: 30px; padding: 0px;font-weight: bold;" formaction = 'B_02_H.jsp'></td>
			</tr>
		</form>
		</table>
