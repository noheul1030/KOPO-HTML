...
<%      try{
        ...
        // 뭐리문 작성
        String query = "SELECT * FROM TupyoDB WHERE name = ?";
...
%>
        ...
        <table cellspacing="1" width=600 border="1">
            <tr>
                <td bgcolor = gold width="50"><p align=center><strong>후보이름</strong></p></td> <!--셀 형태 지정-->
                <td bgcolor = gold width="50"><p align=center><strong>기호</strong></p></td> <!--셀 형태 지정-->
